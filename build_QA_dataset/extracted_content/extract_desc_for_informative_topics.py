...
#     "cid": "25244890",
#     "name": "None",
#     "smile": "C(C/C(=C/C(=O)O)/C(=O)O)CC(=O)O",
#     "descriptions": [
#         [
#             1,
#             "The molecule is a tricarboxylic acid that consists of pent-1-ene having three carboxy groups located at positions 1, 2 and 5 (the Z-geoisomer). It is a conjugate acid of a cis-dihomoaconitate(3-).",
#             " {\"Structure\": {\"Type\": [\"Tricarboxylic acid\"], \"Base\": \"Pent-1-ene\", \"Position 1\": \"Carboxy group\", \"Position 2\": \"Carboxy group\", \"Position 5\": \"Carboxy group\", \"Conjugate Acid\": \"cis-dihomoaconitate(3-)\"}}"
#         ]
#     ]
# },
